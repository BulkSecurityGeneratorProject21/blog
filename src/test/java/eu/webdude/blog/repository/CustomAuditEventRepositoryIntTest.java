...
import eu.webdude.blog.config.audit.AuditEventConverter;
import eu.webdude.blog.domain.PersistentAuditEvent;
...
import static eu.webdude.blog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
